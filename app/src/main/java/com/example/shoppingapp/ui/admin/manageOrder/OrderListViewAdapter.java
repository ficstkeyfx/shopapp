...
public class OrderListViewAdapter extends BaseAdapter
{
    ...
    final ArrayList<OrderPeopleModel> listAccount;

    OrderListViewAdapter(ArrayList<OrderPeopleModel> listAccount)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OrderPeopleModel orderPeople = (OrderPeopleModel) getItem(position);
